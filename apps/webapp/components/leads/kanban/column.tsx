...
export const KanbanColumn = ({ step, leads, loading, loadedAt, columns, closedInfo, onUpdated, onOpenDetails, onMoveStage }: KanbanColumnProps) => {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`w-[80vw] min-w-0 shrink-0 snap-start bg-muted/30 rounded-lg border border-border shadow-sm flex flex-col h-[calc(100vh-156px)] transition-colors md:w-auto md:min-w-[260px] md:flex-1 ${
